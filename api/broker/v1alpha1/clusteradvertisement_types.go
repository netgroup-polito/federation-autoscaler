...
type ClusterAdvertisementSpec struct {
	...
	// foo is an example field of ClusterAdvertisement. Edit clusteradvertisement_types.go to remove/update
	// +optional
...
type ClusterAdvertisementStatus struct {
	...
	// conditions represent the current state of the ClusterAdvertisement resource.
...
type ClusterAdvertisement struct {
	...
	// spec defines the desired state of ClusterAdvertisement
	// +required
	Spec ClusterAdvertisementSpec `json:"spec"`

	// status defines the observed state of ClusterAdvertisement
	// +optional
